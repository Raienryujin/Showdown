      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-xs font-medium text-neutral-400 bg-neutral-800 border border-neutral-700 px-2 py-1 rounded-md">
              {teams.length} Slots
            </span>
          </div>
          ...
          <button
            type="button"
            onClick={addTeam}
            className="mt-4 flex items-center gap-2 text-sm text-emerald-400 font-semibold hover:text-emerald-300 hover:bg-emerald-500/10 py-2 px-3 rounded-lg transition-all"
          >
